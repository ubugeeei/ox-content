<!--
  Vue SFC OG Image Template

  Receives page metadata as props and renders HTML for OG image generation.
  Rendered via Vue SSR (createSSRApp + renderToString) at build time.
-->
